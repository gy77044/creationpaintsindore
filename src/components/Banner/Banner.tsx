...
// import bg from "../../../public/assests/allimg/buckets-paint-floor.jpg";

// const Banner: React.FC = () => {
//   return (
//     <>
//       <div className=" hidden xl:block relative isolate pt-14 lg:px-8')]">
//         <div
...
//         <div
//           className="mx-auto max-w-7xl py-16 sm:py-24 lg:py-32 bg-blue-950/50 bg-blend-soft-light"
//           style={{
//             backgroundImage: `url(${bg})`,
//             backgroundSize: "cover",
//             backgroundPosition: "center",
...
//               </h1>
//               <p className="mt-4 text-lg text-gray-500 animate-new-color-change">
//                 High-quality, durable, and vibrant colors for every space.
//               </p>
//               <a
//                 href="#product"
