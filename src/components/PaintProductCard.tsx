...
const ProductCard: React.FC<{
  ...
  return(
    <div onClick={handleNavigate} className="min-w-[280px] sm:min-w-[300px] max-w-[300px] flex-shrink-0 bg-white hover:bg-gray-100 hover:shadow-xl transition-all shadow-md px-6 py-10 flex flex-col h-[80vh]">
