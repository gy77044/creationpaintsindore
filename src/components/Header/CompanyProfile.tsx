...
const CONTENT_BACKGROUND_PATTERN_URL: string =
  "https://www.creativepaints.in/themes/images/pattern/project-description-pattern.jpg"; // Dotted pattern for content section
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-12">
            ...
            <div className="md:w-1/2 w-full text-gray-700">
              <h3
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(to right, #17a2b8, #dc3545)",
              ...
              <p className="mb-4 text-justify leading-relaxed">
                Creation Paints is a leading manufacturer of decorative paint
                products in India, headquartered in Madhya Pradesh. Founded in
                2024, we began our journey with a clear mission — to establish a
                strong presence in the decorative paints industry. Since then,
                our dedication to quality, innovation, and customer satisfaction
                has been the driving force behind our continued success.
              </p>
              <p className="text-justify leading-relaxed">
                We operate our business nationwide, with our headquarters
