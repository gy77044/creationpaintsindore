...
import { FaComment, FaEnvelope, FaPhone, FaUser } from "react-icons/fa";

const DEALERSHIP_HERO_BG: string =
  "https://www.creativepaints.in/themes/images/dealership.jpg";
        ...
        <div className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <p className="text-gray-700 text-lg mb-12 text-center max-w-2xl mx-auto">
              We’re delighted to collaborate with you in bringing color to life.
              Please complete the form below, and one of our paint specialists
              will get in touch with you shortly
            </p>

            <form
              onSubmit={handleSubmit}
              className="bg-gray-50 p-8 md:p-12 shadow-lg rounded-lg"
            >
              ...
              <div className="text-center mt-10">
                ...
                >
                  Send Your Message <span className="ml-2">&#8594;</span>
                </button>
              </div>
            </form>
          </div>
