...
const MISSION_VISION_HERO_BG: string =
  "https://www.creativepaints.in/upload/pages/2019082817103147.jpg"; 
const MAN_PAINTING_IMAGE: string =
  "https://www.creativepaints.in/upload/pages/201908281506318363.jpg"; 
...
const NumberCounter: React.FC<NumberCounterProps> = ({
  ...
  return (
    <animated.p
      ref={ref}
      className="text-5xl md:text-6xl font-bold text-gray-700 mb-2"
    >
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-12">
            ...
            <div className="md:w-1/2 w-full text-gray-700">
              <p className="mb-4 text-justify leading-relaxed">
                ...
                At Creation Paints, our mission is to deliver an exceptional
                customer experience by offering superior-quality products,
                continuous innovation, and best-in-class service. We believe
                that our success lies in consistently exceeding customer
                expectations and earning their lasting trust and loyalty.
              </p>
              <p className="mb-6 text-justify leading-relaxed">
                <span className="font-semibold text-gray-900">Our Vision</span>{" "}
                To become the most admired paint company in India, recognized
                globally for our capabilities, quality, and commitment to
                excellence.
              </p>
